...
router.get(
  "/users/:userId/questionnaire/createRandom",
  async function (req, res, next) {
    try {
      var userId = parseInt(req.params["userId"])
      const user = await User.findOne({
...
router.post(
  "/users/:userId/questionnaire/create",
  async function (req, res, next) {
    try {
      var userId = parseInt(req.params["userId"])
      ...
      questionnaire = await Questionnaire.findOne({
        ...
        where: {
          [Op.and]: [{ userId: userId }, { id: questionnaire.id }],
        },
      })
      res.json(questionnaire)
    } catch (err) {
...
router.get("/users/:userId/questionnaire", async function (req, res, next) {
  try {
    ...
    if (req.query["recentlyUsed"] != null) {
      querydata_order = [
        [
          ...
          { model: History },
          "recentlyUsed",
          req.query["recentlyUsed"],
        ],
      ]
      querydate_limit = 3
    } else {
      querydata_order = [["id", "ASC"]]
      querydate_limit = 1000
    }
    var questionnaires = await Questionnaire.findAll({
      ...
      where: {
        [Op.and]: [{ userId: userId }, querydata_where_topic],
      },
      attributes: [
        "id",
        "name",
...
router.get(
  "/users/:userId/questionnaire/:questionnaireId",
  async function (req, res, next) {
    var userId = req.params["userId"]
    ...
    var questionnaires = await Questionnaire.findOne({
      ...
      where: {
        [Op.and]: [{ userId: userId }, { id: questionnaireId }],
      },
    })
    res.json(questionnaires)
  },
...
router.get(
  "/users/:userId/questionnaire/:questionnaireId/count",
  async function (req, res, next) {
    var userId = req.params["userId"]
    var questionnaireId = req.params["questionnaireId"]
    var numberOfQuestion = await Question.count({
      where: {
        [Op.and]: [{ questionnaireId: questionnaireId }],
      },
    })
...
router.get(
  "/users/:userId/questionnaire/:questionnaireId/history",
  async function (req, res, next) {
    var userId = req.params["userId"]
    var questionnaireId = req.params["questionnaireId"]
    var history = await History.findOne({
      where: {
        [Op.and]: [{ questionnaireId: questionnaireId }, { userId: userId }],
      },
    })
    res.json(history)
  },
...
router.get(
  "/users/:userId/questionnaire/:questionnaireId/question/createRandom",
  async function (req, res, next) {
    var userId = req.params["userId"]
    var questionnaireId = req.params["questionnaireId"]
...
router.post(
  "/users/:userId/questionnaire/:questionnaireId/question/create",
  async function (req, res, next) {
...
router.get(
  "/users/:userId/questionnaire/:questionnaireId/question",
  async function (req, res, next) {
    var userId = req.params["userId"]
    var questionnaireId = req.params["questionnaireId"]
...
router.post(
  "/users/:userId/questionnaire/:questionnaireId/setRecentlyUsed",
  async function (req, res, next) {
